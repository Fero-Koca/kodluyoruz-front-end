...
/*İçerine button adını yazdığımda buton oluşturacak */
...
/* Map metodu kullanarak obje bilgilerini createFood fonksiyonuna yolladım */
function allFoods () {
  let allMenu = "" // Diğer menüler için değişkeni sıfırlamak lazım
  menu.map( menu =>
...
/* Korea Yemekleri */
function koreaFoods() {
  let allMenu = "" // Değişkeni sıfırladım
  menu.map( menu => {
...
/* Menüdeki yemeklerden birini tanımlayıp diğerlerini bu fonksiyondan türettim*/
